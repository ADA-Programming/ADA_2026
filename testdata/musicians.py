...
# Buffalo Springfield
neilYoung = Musician('Neil Young')
stephenStills = Musician('Stephen Stills')
richieFurray = Musician('Richie Furray')
deweyMartin = Musician('Dewey Martin')
brucePalmer = Musician('Bruce Palmer')
